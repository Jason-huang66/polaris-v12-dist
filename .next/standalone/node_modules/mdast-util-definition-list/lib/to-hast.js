...
export const mdastDefList2hast = (h, node, _parent) => {
...
export const mdastDefListTerm2hast = (h, node, _parent) => {
    return h(node, 'dt', {}, all(h, node));
};
export const mdastDefListDescription2hast = (h, node, _parent) => {
    const children = [];
